...
<body data-bs-theme="dark">
    <form class="container mt-5 d-flex flex-column gap-3 align-items-center">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" aria-label="Badword" aria-describedby="basic-addon1">
        </div>
